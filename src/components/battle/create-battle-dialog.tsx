...
export function CreateBattleDialog({ trigger, open, onOpenChange }: CreateBattleDialogProps) {
  ...
  const { positions, isLoading: positionsLoading, hasPositions } = useAvailableBattlePositions();
  const {
    startBattleCreation,
    approveToken,
    createBattle,
  ...
  const selectedDurationInfo = BATTLE_DURATIONS.find(d => d.value === selectedDuration);
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="bg-gradient-to-br from-gray-900/98 via-gray-800/95 to-gray-900/98 border-0 text-white backdrop-blur-xl max-w-3xl max-h-[95vh] overflow-y-auto shadow-2xl shadow-cyan-500/10">
        ...
        <DialogHeader className="relative z-10 text-center pb-6">
          <div className="flex items-center justify-center mb-4">
            <div className="relative">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-500/25">
          ...
          <DialogTitle className="text-3xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">
            Create Epic Battle
          </DialogTitle>
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="space-y-4">
              <div className="text-center">
                <Label className="text-xl font-semibold text-white mb-2 block">Choose Your Battle Style</Label>
                <p className="text-gray-400 text-sm">Select the type of competition that suits your strategy</p>
              </div>

              <Tabs value={battleType} onValueChange={(value) => setBattleType(value as 'range' | 'fee')}>
                <TabsList className="grid w-full grid-cols-2 bg-gray-800/50 border border-gray-700/50 rounded-2xl p-2 h-auto">
                  ...
                  >
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <span className="text-xs opacity-80">Price Range Strategy</span>
                    </div>
                  </TabsTrigger>
                  <TabsTrigger
                    value="fee"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-purple-500/25 rounded-xl py-4 px-6 transition-all duration-300"
                  >
                    <div className="flex flex-col items-center space-y-2">
                      <Coins className="w-6 h-6" />
                      <span className="font-semibold">Fee Battle</span>
                      <span className="text-xs opacity-80">Fee Generation Race</span>
                    </div>
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="range" className="mt-6">
                  <div className="bg-gradient-to-r from-cyan-900/30 to-cyan-800/20 border border-cyan-500/30 rounded-xl p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-cyan-300 font-semibold mb-1">Range Battle Strategy</h4>
                        <p className="text-cyan-200/80 text-sm leading-relaxed">
                          Victory goes to the LP position that stays within its price range the longest.
                          If both positions remain in range, the winner is determined by the highest percentage gain.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <TabsContent value="fee" className="mt-6">
                  <div className="bg-gradient-to-r from-purple-900/30 to-purple-800/20 border border-purple-500/30 rounded-xl p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-purple-300 font-semibold mb-1">Fee Battle Strategy</h4>
                        <p className="text-purple-200/80 text-sm leading-relaxed">
                          The ultimate fee generation competition. Victory belongs to the LP position
                          that accumulates trading fees at the fastest rate.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="text-center">
                <Label className="text-xl font-semibold text-white mb-2 block">Select Your Weapon</Label>
                <p className="text-gray-400 text-sm">Choose the LP position you want to battle with</p>
              </div>
              ...
              {positionsLoading ? (
                <div className="flex flex-col items-center justify-center py-12 space-y-4">
                  ...
                  <div className="text-center">
                    <p className="text-gray-300 font-medium">Scanning Your Arsenal</p>
                    <p className="text-gray-500 text-sm">Loading your LP positions...</p>
                  </div>
                </div>
              ) : !hasPositions ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <div>
                    <p className="text-gray-300 font-medium mb-2">No Active Positions Found</p>
                    <p className="text-gray-500 text-sm">You need active LP positions to create battles</p>
                  </div>
                </div>
              ) : (
                <div className="space-y-3">
                  <Select value={selectedTokenId} onValueChange={setSelectedTokenId}>
                    <SelectTrigger className="bg-gray-800/50 border border-gray-700/50 hover:border-gray-600/50 h-14 rounded-xl transition-all duration-200">
            ...
            <div className="space-y-4">
              <div className="text-center">
                <Label className="text-xl font-semibold text-white mb-2 block">Set Battle Duration</Label>
                <p className="text-gray-400 text-sm">How long will this epic battle last?</p>
              </div>
                    ...
                    >
                      <div className="flex items-center justify-between w-full py-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <span className="font-medium text-white">{duration.label}</span>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-200/80 text-sm">
                        Battle will last for {formatDuration(selectedDuration)}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {error && (
              <div className="bg-gradient-to-r from-red-900/30 to-red-800/20 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-red-300 font-semibold mb-1">Battle Creation Failed</h4>
...
export function CreateBattleButton() {
  return (
    <CreateBattleDialog
      trigger={
        <Button className="relative bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 hover:from-cyan-600 hover:via-purple-700 hover:to-pink-700 text-white h-14 px-10 rounded-2xl font-bold shadow-2xl shadow-cyan-500/25 transition-all duration-300 hover:shadow-cyan-500/40 transform hover:scale-105 active:scale-95 overflow-hidden group">
          {/* Animated background */}
