...
// Only extend HTML div props for the tooltip content container
interface ChartTooltipContentProps extends React.ComponentProps<"div"> {
  ...
  // Recharts-specific props that should NOT be passed to DOM
...
// Helper to extract item config from a payload with proper type checking
