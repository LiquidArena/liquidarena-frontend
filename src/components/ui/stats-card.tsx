export default function StatsCard({
  ...
  return (
    <div className="group relative overflow-hidden group bg-gray-800/50 border border-white/10 rounded-2xl p-2 backdrop-blur-sm hover:shadow-lg/20 hover:shadow-cyan-500/50 transition-all duration-300 ease-in-out">
